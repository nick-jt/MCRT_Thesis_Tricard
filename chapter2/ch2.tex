...
Neglecting thermal radiation may lead to large over-predictions of flow temperature by upwards of 200K in some cases \cite{Modest2016RadiativeSystems,Wu2021LimitationsFires}, as well as underpredictions of flame temperature in others \cite{.

\textbf{Finish reading Modest, Haworth}
...
Wall heat flux from thermal radiation is of the same order of magnitude as that of convection \cite{}
