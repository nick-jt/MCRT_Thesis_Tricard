...
\subsection{Case Setup}
Figure \ref{fig:PoolFire_diagram} displays the timestep used for frozen field analysis of the pool flame. The mesh 

\begin{figure}
\includegraphics[width=\linewidth]{figures/ch4/contour_early.png}
\caption{Contours of an early timestep of the pool fire simulation. Axes dimensions are in meters.}
