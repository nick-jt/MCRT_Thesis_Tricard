...
In order to better understand the influence of radiation within the flame, figure \ref{fig:PoolFire_quadcomparison} displays four relevant parameters for the radiation calculation. 
The contours of temperature show the two streams of reacting flow billowing upwards as a result of the buoyant force induce on the lower-density regions.
