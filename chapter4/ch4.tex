...
\caption{Various parameters along the centerline of a non-gray flame. Values normalized by maximum values along the sampled line.}
...
Several time-steps of the time-accurate simulation are presented in 
